...
public class QuestionService {
    ...
    public GetQuestionsResponse getQuestionsByCategory(AuthInfo authInfo, GetQuestionsRequest getQuestionsRequest) {
        ...
        Page<QuestionElement> questionElements = interviewQuestionRepository.findQuestionsByCategory(InterviewCategory.ofName(getQuestionsRequest.getCategory())
                ,pageRequest);
        return GetQuestionsResponse.of(questionElements);
    }
}
